...
class _HolderState extends State<Holder> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (kIsWeb) {
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        var limited = b.browserAgent == BrowserAgent.Safari;
        limited = limited && version.allows(Version.parse(b.version));
        limited = limited || b.browserAgent == BrowserAgent.Firefox;
  ...
  Widget build(BuildContext context) {
    ...
    if (Theme.of(context).colorScheme.primary is MaterialColor) {
      ...
      needleColor = needleColor.materialLerp(shade: 300)!;
    }
